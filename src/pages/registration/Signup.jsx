...
const Signup = () => {
    ...
    *========================================================================**/
    ...
    const userSignupFunction = async () => {
        ...
        if (userSignup.name === "" || userSignup.email === "" || userSignup.password === "") {
        ...
        else if(isNumeric(userSignup.name)){
            toast.error("In name filed only characters are allowed");
        }
       
        else if(  !isvalidemail.test(userSignup.email)){
            toast.error("Please enter email in valid format ( xyz123@gmail.com )");
         }
         ...
         else if(!password.test(userSignup.password )){
            toast.error("Password must contain one Uppercase letter, One LoweCase letter, one Number, one Sepcial Character, and Range of Password is between 8-15 characters");
         }
